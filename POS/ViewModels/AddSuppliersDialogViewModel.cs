...
{
    public class AddSuppliersDialogViewModel : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<Supplier> _itemList;
        public ObservableCollection<Supplier> ItemList
        {
        ...
        public AddSuppliersDialogViewModel()
        {
            ...
            ItemList = new ObservableCollection<Supplier>();
            LoadSuppliers();
        }
        ...
        {
            // Retrieve Suppliers from the DbContext
        ...
        private void Add(object parameter)
        {
            ...
            // Add the new Supplier to the ObservableCollection
            ItemList.Add(newSupplier);
        ...
        private void Edit(object parameter)
        {
            if (SelectedItem != null)
            {
                ...
                // Find the selected Supplier in the DbContext
                Supplier SupplierToUpdate = _dbContext.Suppliers.Find(SelectedItem.Id);
                ...
                SupplierToUpdate.Website = Website;
                SupplierToUpdate.Notes = Notes;
                SupplierToUpdate.CommercialRegister = CommercialRegister;
                SupplierToUpdate.TaxCard = TaxCard;
                SupplierToUpdate.Image = SaveImage(ImageSource);
        ...
        private void DeleteItem(object parameter)
        {
            if (SelectedItem != null)
            {
                ...
                {
                    // Find the selected Supplier in the DbContext
                    Supplier SupplierToDelete = _dbContext.Suppliers.Find(SelectedItem.Id);

                    // Remove the Supplier from the DbContext
        ...
        private void SelectImage(object parameter)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                try
                {
                    ...
                    if (SelectedItem != null)
                    {
                        // Update the image path of the selected Supplier
        ...
        public string SaveImage(string imagePath)
        {
            ...
            try
            {
                ...
                string directoryPath = Path.Combine(Environment.CurrentDirectory, "images", "Suppliers");
